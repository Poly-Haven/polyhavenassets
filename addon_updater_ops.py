...
def register(bl_info):
    ...
    updater.website = "https://github.com/Poly-Haven/polyhavenassets"
    ...
    updater.overwrite_patterns = ["*.png", "*.jpg", "*.md", "*.txt"]
